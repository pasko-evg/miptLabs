...
# Входные данные: Первое число(1 < N ≤ 255) - количество жителей. Следующие N чисел(0 или 1), разделенных пробелами - ответы жителей.


# TODO: #1 Чужое решение, нужно написать свое.
